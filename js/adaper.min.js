    ...
    return function a(o, s, c) {
        ...
        3: [function(e, t, r) {
            ...
            r.shimOnTrack = function(a) {
                if ("object" !== (void 0 === a ? "undefined" : s(a)) || !a.RTCPeerConnection || "ontrack"in a.RTCPeerConnection.prototype)
            ...
            r.shimAddTrackRemoveTrack = function(o) {
                ...
                o.RTCPeerConnection.prototype.setLocalDescription = function(e) {
                    return arguments.length && e.type && (n = this,
                    i = (t = e).sdp,
                ...
                o.RTCPeerConnection.prototype.removeTrack = function(t) {
                    ...
                    n && (1 === n.getTracks().length ? this.removeStream(this._reverseStreams[n.id]) : n.removeTrack(t.track),
            ...
            r.shimPeerConnection = function(n) {
                ...
                n.RTCPeerConnection.prototype.addIceCandidate = function(e, t) {
                    return i || e ? r.version < 78 && e && "" === e.candidate ? Promise.resolve() : a.apply(this, arguments) : (t && t.apply(null),
                    Promise.resolve())
                }
            }
            ,
            ...
            r.shimGetUserMedia = function(e) {
                ...
                function s(i) {
                    ...
                    return Object.keys(i).forEach(function(t) {
                        if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                            ...
                            void 0 !== r.exact && "number" != typeof r.exact ? (a.mandatory = a.mandatory || {},
                            a.mandatory[n("", t)] = r.exact) : ["min", "max"].forEach(function(e) {
                                void 0 !== r[e] && (a.mandatory = a.mandatory || {},
                ...
                function n(r, n) {
                    ...
                    if ((r = JSON.parse(JSON.stringify(r))) && "object" === d(r.audio)) {
                        ...
                        e((r = JSON.parse(JSON.stringify(r))).audio, "autoGainControl", "googAutoGainControl"),
                    ...
                    if (r && "object" === d(r.video)) {
                        ...
                        if (i && ("user" === i.exact || "environment" === i.exact || "user" === i.ideal || "environment" === i.ideal) && (!o.mediaDevices.getSupportedConstraints || !o.mediaDevices.getSupportedConstraints().facingMode || t)) {
                            ...
                            var a = void 0;
                            if ("environment" === i.exact || "environment" === i.ideal ? a = ["back", "rear"] : "user" !== i.exact && "user" !== i.ideal || (a = ["front"]),
                            a)
                                return o.mediaDevices.enumerateDevices().then(function(e) {
                                    ...
                                    return !t && e.length && a.includes("back") && (t = e[e.length - 1]),
                                    t && (r.video.deviceId = i.exact ? {
                                        exact: t.deviceId
                                    } : {
                                        ideal: t.deviceId
                                    }),
        ...
        6: [function(e, t, r) {
            ...
            r.shimRTCIceCandidate = function(t) {
                ...
                t.RTCIceCandidate = function(e) {
                    if ("object" === (void 0 === e ? "undefined" : a(e)) && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substr(2)),
            ...
            r.shimMaxMessageSize = function(e) {
                ...
                e.RTCPeerConnection.prototype.setRemoteDescription = function(e) {
                    var t, r;
                    this._sctp = null,
                    "chrome" === c.browser && 76 <= c.version && ("plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                        get: function() {
                            return void 0 === this._sctp ? null : this._sctp
                        },
                        enumerable: !0,
                    ...
                    if (function(e) {
                        ...
                        var n = function(e) {
                          ...
                          , i = (t = n,
                        r = 65536,
                        "firefox" === c.browser && (r = c.version < 57 ? -1 === t ? 16384 : 2147483637 : c.version < 60 ? 57 === c.version ? 65535 : 65536 : 2147483637),
                        r)
                          , a = function(e, t) {
                            var r = 65536;
                            "firefox" === c.browser && 57 === c.version && (r = 65535);
                            var n = p.default.matchPrefix(e.sdp, "a=max-message-size:");
                            return 0 < n.length ? r = parseInt(n[0].substr(19), 10) : "firefox" === c.browser && -1 !== t && (r = 2147483637),
                            r
                        }(e, n)
                          , o = void 0;
            ...
            ;
            var n, i = e("sdp"), p = (n = i) && n.__esModule ? n : {
                default: n
            }, o = function(e) {
                {
                    if (e && e.__esModule)
        ...
        11: [function(e, t, r) {
            ...
            r.shimPeerConnection = function(n) {
                ...
                if (i.version < 68) {
                    ...
                    n.RTCPeerConnection.prototype.addIceCandidate = function(e, t) {
                        return e ? e && "" === e.candidate ? Promise.resolve() : r.apply(this, arguments) : (t && t.apply(null),
                        Promise.resolve())
                    }
                }
                var a = {
            ...
            r.shimAddTransceiver = function(e) {
                ...
                s && (e.RTCPeerConnection.prototype.addTransceiver = function(e, t) {
                    ...
                    if (n) {
                        var a = i.sender
                          , o = a.getParameters();
                        "encodings"in o || (o.encodings = r.sendEncodings,
                        this.setParametersPromises.push(a.setParameters(o).catch(function() {})))
                    }
                    return i
                }
                )
            ...
            r.shimGetUserMedia = function(e) {
                ...
                !(55 < t.version && "autoGainControl"in n.mediaDevices.getSupportedConstraints())) {
                    ...
                    if (n.mediaDevices.getUserMedia = function(e) {
                        return "object" === (void 0 === e ? "undefined" : c(e)) && "object" === c(e.audio) && (e = JSON.parse(JSON.stringify(e)),
                    ...
                    if (r && r.prototype.applyConstraints) {
                        ...
                        r.prototype.applyConstraints = function(e) {
                            return "audio" === this.kind && "object" === (void 0 === e ? "undefined" : c(e)) && (e = JSON.parse(JSON.stringify(e)),
                ...
                e.RTCPeerConnection = function(e, t) {
                    if (e && e.iceServers) {
                        for (var r = [], n = 0; n < e.iceServers.length; n++) {
                            ...
                            !i.hasOwnProperty("urls") && i.hasOwnProperty("url") ? (o.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
        ...
        15: [function(e, t, r) {
            ...
            r.disableWarnings = function(e) {
                ...
                "adapter.js deprecation warnings " + (e ? "disabled" : "enabled")) : new Error("Argument type: " + (void 0 === e ? "undefined" : n(e)) + ". Please use a boolean.")
            }
            ,
            r.log = function() {
        ...
        16: [function(e, t, r) {
            ...
            function c(e, t, r, n, i) {
                ...
                if (a += G.writeIceParameters(e.iceGatherer.getLocalParameters()),
                a += G.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active"),
                a += "a=mid:" + e.mid + "\r\n",
                ...
                e.rtpSender) {
                    ...
                    e.sendEncodingParameters[0].rtx && (a += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + s,
                ...
                return d.codecs.forEach(function(r) {
                    for (var e = 0; e < p.codecs.length; e++) {
                        ...
                        if (r.name.toLowerCase() === t.name.toLowerCase() && r.clockRate === t.clockRate) {
                            if ("rtx" === r.name.toLowerCase() && r.parameters && t.parameters.apt && (n = r,
                            i = t,
                            a = d.codecs,
                            o = p.codecs,
                            c = s = void 0,
            ...
            t.exports = function(I, j) {
                    ...
                    if (!p.onlocalcandidate) {
                        ...
                        p.onlocalcandidate = function(e) {
                            if (!(d.usingBundle && 0 < c)) {
                                ...
                                if (n)
                                    "new" !== p.state && "gathering" !== p.state || (p.state = "completed");
                                else {
                                    "new" === p.state && (p.state = "gathering"),
                                    r.component = 1,
                                    r.ufrag = p.getLocalParameters().usernameFragment;
                                    var i = G.writeCandidate(r);
                                    t.candidate = Object.assign(t.candidate, G.parseCandidate(i)),
                                ...
                                o && (d._dispatchEvent("icecandidate", new Event("icecandidate")),
                ...
                n.prototype.setLocalDescription = function(e) {
                    ...
                    if (-1 === ["offer", "answer"].indexOf(e.type))
                        return Promise.reject(m("TypeError", 'Unsupported type "' + e.type + '"'));
                    if (!a("setLocalDescription", e.type, f.signalingState) || f._isClosed)
                        return Promise.reject(m("InvalidStateError", "Can not set local " + e.type + " in state " + f.signalingState));
                    if ("offer" === e.type)
                        ...
                        t.forEach(function(e, t) {
                            ...
                            if (!(G.isRejected(e) && 0 === G.matchPrefix(e, "a=bundle-only").length) && !r.rejected) {
                                ...
                                l && (d.role = "server"),
                                f.usingBundle && 0 !== t || (f._gather(r.mid, t),
                                "new" === i.state && i.start(n, c, l ? "controlling" : "controlled"),
                    ...
                    "offer" === e.type ? f._updateSignalingState("have-local-offer") : f._updateSignalingState("stable"),
                    Promise.resolve()
                }
                ,
                n.prototype.setRemoteDescription = function(_) {
                    ...
                    return w.canTrickleIceCandidates = !!t && 0 <= t.substr(14).split(" ").indexOf("trickle"),
                    e.forEach(function(e, t) {
                        ...
                        if (i || "application" === n && ("DTLS/SCTP" === a || "UDP/DTLS/SCTP" === a))
                            w.transceivers[t] = {
                                mid: c,
                                kind: n,
                                protocol: a,
                            ...
                            if (("offer" === _.type || "answer" === _.type) && !i && O && 0 < t && w.transceivers[t] && (w._disposeIceAndDtlsTransports(t),
                            ...
                            "offer" !== _.type || i) {
                                if ("answer" === _.type && !i) {
                                    ...
                                    R.length && "new" === u.state && (!D && !P || O && 0 !== t ? R.forEach(function(e) {
                                        N(d.iceTransport, e)
                                    }) : u.setRemoteCandidates(R)),
                                    O && 0 !== t || ("new" === u.state && u.start(p, g, "controlling"),
                                    ...
                                    !l || "sendrecv" !== o && "sendonly" !== o ? delete d.rtpReceiver : (y = l.track,
                                    s ? (k[s.stream] || (k[s.stream] = new I.MediaStream),
                                    L(y, k[s.stream]),
                                    x.push([y, l, k[s.stream]])) : (k.default || (k.default = new I.MediaStream),
                                    L(y, k.default),
                                    x.push([y, l, k.default])))
                                }
                            } else {
                                (d = w.transceivers[t] || w._createTransceiver(n)).mid = c,
                                d.iceGatherer || (d.iceGatherer = w._createIceGatherer(t, O)),
                                R.length && "new" === d.iceTransport.state && (!P || O && 0 !== t ? R.forEach(function(e) {
                                    N(d.iceTransport, e)
                                }) : d.iceTransport.setRemoteCandidates(R)),
                                v = I.RTCRtpReceiver.getCapabilities(n),
                                j < 15019 && (v.codecs = v.codecs.filter(function(e) {
                                    return "rtx" !== e.name
                                })),
                                m = d.sendEncodingParameters || [{
                                    ssrc: 1001 * (2 * t + 2)
                                ...
                                if ("sendrecv" === o || "sendonly" === o) {
                                    if (E = !d.rtpReceiver,
                                    l = d.rtpReceiver || new I.RTCRtpReceiver(d.dtlsTransport,n),
                                    E)
                                        y = l.track,
                                        s && "-" === s.stream || (b = s ? (k[s.stream] || (k[s.stream] = new I.MediaStream,
                                        ...
                                        k[s.stream]) : (k.default || (k.default = new I.MediaStream),
                                        k.default)),
                                        b && (L(y, b),
                                        d.associatedRemoteMediaStreams.push(b)),
                                        x.push([y, l, b])
                                } else
                                    d.rtpReceiver && d.rtpReceiver.track && (d.associatedRemoteMediaStreams.forEach(function(e) {
                                        var t, r, n = e.getTracks().find(function(e) {
                                            return e.id === d.rtpReceiver.track.id
                                        });
                                        n && (t = n,
                                        (r = e).removeTrack(t),
                                        r.dispatchEvent(new I.MediaStreamTrackEvent("removetrack",{
                                            track: t
                                        })))
                                    }),
                    ...
                    void 0 === w._dtlsRole && (w._dtlsRole = "offer" === _.type ? "active" : "passive"),
                    w._remoteDescription = {
                        type: _.type,
                        sdp: _.sdp
                    },
                    "offer" === _.type ? w._updateSignalingState("have-remote-offer") : w._updateSignalingState("stable"),
                ...
                n.prototype.createOffer = function() {
                    ...
                    for (s.transceivers.forEach(function(e) {
                        ...
                        0 < t && (s._createTransceiver("audio"),
                        t--),
                        0 < r && (s._createTransceiver("video"),
                        r--);
                    ...
                    i.transceivers.forEach(function(e, t) {
                        if (!(o < t + 1)) {
                            ...
                            if (e.stream)
                                ...
                                r && 15019 <= j && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = {
                ...
                n.prototype.addIceCandidate = function(c) {
                    ...
                    return c && void 0 === c.sdpMLineIndex && !c.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(e, t) {
                        ...
                        if (c && "" !== c.candidate) {
                            ...
                            for (var s = 0; s < p.transceivers.length && (p.transceivers[s].rejected || (p.transceivers[s].iceTransport.addRemoteCandidate({}),
                            (d = G.getMediaSections(p._remoteDescription.sdp))[s] += "a=end-of-candidates\r\n",
                            p._remoteDescription.sdp = G.getDescription(p._remoteDescription.sdp) + d.join(""),
                            !p.usingBundle)); s++)
                                ;
                        e()
        ...
        17: [function(e, t, r) {
            ...
            p.writeFmtp = function(t) {
                var e = ""
                  , r = t.payloadType;
                if (void 0 !== t.preferredPayloadType && (r = t.preferredPayloadType),
            ...
            p.parseSsrcMedia = function(e) {
                var t = e.indexOf(" ")
                  ...
                  , n = e.indexOf(":", t);
                return -1 < n ? (r.attribute = e.substr(t + 1, n - t - 1),
            ...
            p.parseRtpParameters = function(e) {
                for (var t = {
                    ...
                    if (a) {
                        ...
                        switch (o.parameters = s.length ? p.parseFmtp(s[0]) : {},
                        o.rtcpFeedback = p.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(p.parseRtcpFb),
                        t.codecs.push(o),
                        o.name.toUpperCase()) {
                        case "RED":
                        case "ULPFEC":
            ...
            p.writeMediaSection = function(e, t, r, n) {
                ...
                if (i += p.writeIceParameters(e.iceGatherer.getLocalParameters()),
                ...
                e.rtpSender) {
                    ...
                    e.sendEncodingParameters[0].rtx && (i += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + a,
